...
sys.path.append('/Users/markk/git/tensorflow/models/research')
...
flags.DEFINE_string('label_map_path', 'raccoon_label_map.pbtxt',
...
def main(_):
    ...
    logging.info('Reading from raccoon dataset.')
    ...
    train_output_path = os.path.join(FLAGS.output_dir, 'raccoon_train.record')
    val_output_path = os.path.join(FLAGS.output_dir, 'raccoon_val.record')
